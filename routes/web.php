...
Route::get('/products/search-detail', [IndexController::class, 'search_detail'])->name('search_detail');
Route::get('/products/search-text', [IndexController::class, 'search_text'])->name('search_text');
